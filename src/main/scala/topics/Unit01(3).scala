...
object Unit001 {
  ...
  @main def exercise12aa(): Unit =
    println(add(2)(5))
    println(add(2)(0))
    println(plus(2, 5))
    println(plus(2, 0))

  @main def exercise12bb(): Unit =
    println(nums)
  ...
  @main def exercise15aa(): Unit =
    println(nums.map(sub(_)(5)))
    println(nums.map(div(_)(2)))

  @main def exercise15bb(): Unit =
